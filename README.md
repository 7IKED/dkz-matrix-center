...
![Lines](https://img.shields.io/badge/Lines-761-ffb800?style=for-the-badge)
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-matrix-center.git

# Oeffnen
cd dkz-matrix-center
